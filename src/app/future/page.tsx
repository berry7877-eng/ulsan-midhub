...
export const metadata = {
  title: "미래 — 울산 미드허브",
  description: "교육·취업·정책·노후설계까지, 중장년의 다음 걸음을 준비하는 곳.",
};
        ...
        <div className="grid grid-cols-2 gap-4">
          {tiles.map((t) => (
            ...
            >
              ...
              <p className={`mt-1 text-[13px] font-medium leading-snug ${t.subColor}`}>{t.sub} →</p>
            </Link>
          ))}
        </div>
      </main>
